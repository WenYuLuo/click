...
if __name__ == '__main__':
    click_arr = np.load('/home/fish/ROBB/CNN_click/click/CNNDet/RoughToothed/Rough Tooth_Bahamas(AUTEC)-Unannotated/Set6-A3-092905-H29-0300-0330-1114-1144loc_N972.npy')
